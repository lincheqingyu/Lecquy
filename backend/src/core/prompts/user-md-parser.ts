...
// English: This file (user-md-parser.ts) belongs to the backend 核心运行时与配置 layer in backend/src/core/prompts/user-md-parser.ts, wiring upstream callers with downstream runtime logic.
