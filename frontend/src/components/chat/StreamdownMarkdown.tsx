// 中文：本文件（StreamdownMarkdown.tsx）位于 frontend/src/components/chat/StreamdownMarkdown.tsx，属于frontend链路中的前端组件代码，连接上游调用方与下游执行逻辑。
// English: This file (StreamdownMarkdown.tsx) belongs to the frontend 前端组件 layer in frontend/src/components/chat/StreamdownMarkdown.tsx, wiring upstream callers with downstream runtime logic.
